...
function VolunteerLayout() {
  ...
  const navigation = [
    { name: 'Dashboard', to: '/volunteer', icon: FaHome },
    { name: 'Profile', to: '/volunteer/profile', icon: FaUser },
    { name: 'Trainings', to: '/volunteer/trainings', icon: FaGraduationCap },
    { name: 'Events', to: '/volunteer/events', icon: FaCalendarAlt },
    { name: 'Feedback', to: '/volunteer/feedback', icon: FaCommentAlt },
  ];
