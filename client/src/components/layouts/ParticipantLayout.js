...
function ParticipantLayout() {
  ...
  const navigation = [
    { name: 'Dashboard', to: '/participant', icon: FaHome },
    { name: 'Profile', to: '/participant/profile', icon: FaUser },
    { name: 'Events', to: '/participant/events', icon: FaCalendarAlt },
    { name: 'Feedback', to: '/participant/feedback', icon: FaCommentAlt },
    { name: 'Support', to: '/participant/support', icon: FaLifeRing },
  ];
